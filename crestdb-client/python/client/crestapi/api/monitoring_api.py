...
class MonitoringApi(object):
    ...
    def list_payload_tag_info(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.list_payload_tag_info(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.list_payload_tag_info_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_payload_tag_info_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_payload_tag_info_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves monitoring information on payload as a list of PayloadTagInfoDtos.  # noqa: E501

        This method allows to perform search and sorting.Arguments: by=<pattern>, page={ipage}, size={isize}, sort=<sortpattern>. The pattern <pattern> is in the form <param-name><operation><param-value>       <param-name> is the name of one of the fields in the dto       <operation> can be [< : >] ; for string use only [:]        <param-value> depends on the chosen parameter. A list of this criteria can be provided       using comma separated strings for <pattern>.      The pattern <sortpattern> is <field>:[DESC|ASC]  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_payload_tag_info_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            response_type='list[PayloadTagInfoDto]',  # noqa: E501
