...
class PayloadsApi(object):
    ...
    def get_payload(self, hash, **kwargs):  # noqa: E501
        ...
        :param str format: The format of the output data: BLOB or DTO in JSON format
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_payload_with_http_info(self, hash, **kwargs):  # noqa: E501
        ...
        all_params = ['hash', 'format']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        header_params = {}
        if 'format' in params:
            header_params['format'] = params['format']  # noqa: E501
    ...
    def store_payload_with_iov_multi_form(self, file, tag, since, **kwargs):  # noqa: E501
        ...
        This method allows to insert a Payload and an IOV. Arguments: since,tagname,stream,end time.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str format: The format of the input data
    ...
    def store_payload_with_iov_multi_form_with_http_info(self, file, tag, since, **kwargs):  # noqa: E501
        ...
        all_params = ['file', 'tag', 'since', 'format', 'endtime']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
