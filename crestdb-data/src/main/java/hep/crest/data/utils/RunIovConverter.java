...
public final class RunIovConverter {
	...
	private static final Logger log = LoggerFactory.getLogger(RunIovConverter.class);
	...
	public static void main(String[] args) {
		...
		BigInteger since = BigInteger.valueOf(1234296291171690L);
		BigInteger until = BigInteger.valueOf(1234300586138985L);
		Long runs = RunIovConverter.getRun(since);
		Long runu = RunIovConverter.getRun(until);
		log.info("Hello converter : run is {} {} ", runs ,runu);
	}
}
