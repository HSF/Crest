...
public class TagMeta implements java.io.Serializable {
	...
	*/
	 ...
	 * @param payloadInfo
	 */
	public TagMeta(String tagName, String description, Integer chansize, Integer colsize, Blob channelInfo, Blob payloadInfo) {
		super();
	...
	public String toString() {
		return "TagMeta [tagName=" + tagName + ", description=" + description + ", chansize=" + chansize + ", colsize="
				+ colsize + ", insertionTime="+ insertionTime + "]";
	}
