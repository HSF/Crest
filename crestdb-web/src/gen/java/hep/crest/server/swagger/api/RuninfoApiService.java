...
public abstract class RuninfoApiService {
    ...
    public abstract Response selectRunInfo( String from, String to, String format, Integer page, Integer size, String sort,SecurityContext securityContext, UriInfo info) throws NotFoundException;
}
